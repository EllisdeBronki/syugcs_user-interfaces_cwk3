...
Waterbody::Waterbody(const std::string& location, const std::string& tm, const std::string& pollutant, const std::string& pollutantInfo, const std::string& pollutantNotation, const std::string& resQualifier, double res, const std::string& unit, const std::string& matType, bool compliant):
